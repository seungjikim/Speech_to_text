package com.mp.speach_to_text.D;
...
public class SpeechAPI {
    ...
    private static final int ACCESS_TOKEN_EXPIRATION_TOLERANCE = 30 * 60 * 1000; //  30 min
    private static final int ACCESS_TOKEN_FETCH_MARGIN = 60 * 1000; //one minutes
    ...
    public void startRecognizing(int sampleRate) {
        if (mApi == null) {
            Log.w(TAG, "API not ready. Ognoring the request");
            return;
        }
        //Configure the API
    ...
    public interface Listener {
        //called when a new piece of text was recognized by the api
    ...
    private class AccessTokenTask extends AsyncTask<Void, Void, AccessToken> {
        ...
        protected AccessToken doInBackground(Void... voids) {
            ...
            try {
                ...
                Log.e(TAG, "Faild to obtain access token.", e);
            }
            return null;
        }
        ...
        protected void onPostExecute(AccessToken accessToken) {
            ...
            if (mHandler != null) {
                mHandler.postDelayed(mFetchAccessTokenRunnable, Math.max(accessToken.getExpirationTime().getTime() - System.currentTimeMillis() - ACCESS_TOKEN_FETCH_MARGIN, ACCESS_TOKEN_EXPIRATION_TOLERANCE));
            }
        }
    }
}
