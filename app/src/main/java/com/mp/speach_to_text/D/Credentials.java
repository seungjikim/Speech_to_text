        ...
        return new ClientInterceptors.CheckedForwardingClientCall<ReqT, RespT>(
            next.newCall(method,callOptions))
            {
                ...
                throws StatusException {
                    ...
                    synchronized (this) {
                        Map<String, List<String>> latesMetadata = getRequestMetaData(uri);
                        if (mLastMetadata == null || mLastMetadata != latesMetadata) {
                            mLastMetadata = latesMetadata;
            ...
            private URI serviceUri(Channel channel, MethodDescriptor<?, ?> method)
                ...
                URI uri;
                try {
                    uri = new URI(schema, authority, path, null, null);
